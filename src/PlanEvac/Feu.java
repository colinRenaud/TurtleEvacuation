...
public class Feu extends Turtle{
	...
	private final int timeToSpread = 200; // each timeBound speed there is a fire generation
	...
	protected void activate(){
		...
		setNextAction("act");
		setColor(Color.red);
		s = getEnvironment().getPheromone("feu", 20,50); // evaporation / diffusion : 20/50
	...
	protected void toSpread() {
		if(nbPropagation < nbPropagationMAX + 1) {
			...
			if(getEnvironment().getPheromone("feu").get(xcor(),ycor()) > 2) {
				Feu f1 = new Feu();
				f1.propagé = true;
